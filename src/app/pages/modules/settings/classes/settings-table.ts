...
export abstract class SettingsTable<T extends {id: number}> implements OnInit, OnDestroy {
  ...
  protected abstract columns: Column<T>[];
  ...
  ngOnInit(): void {
    this.route.queryParamMap
      ...
      .subscribe(queryParamMap => {
        ...
        this.sortCol = this.getEnumParamSafely(queryParamMap, 'sortCol', this.columns.map(col => col.field) as string[], this.sortCol as string) as keyof T;
  ...
  getColTitle(col: Column<T>): string {
