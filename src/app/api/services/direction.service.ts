...
'name'?: string;
  ...
  /**
   * Список стран (устаревшее, меняем на /direction_country ).
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
...
'time_edit'?: string;
  ...
  /**
   * Список городов (устаревшее, меняем на /direction_city ).
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
...
'time_edit'?: string;
  ...
  /**
   * Список точек (аэропорт/порт/станция) (устаревшее, меняем на /direction_point).
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
...
'time_edit'?: string;
  ...
  /**
   * Список границ  (устаревшее, меняем на /direction_border).
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
